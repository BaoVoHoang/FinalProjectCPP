...
class Commit {
    ...
    public:
        ...
        // setters
        int setAuthor   (string nAuthor)    { this->author = std::move(nAuthor);       return 0;}
        int setMessage  (string nMessage)   { this->message = std::move(nMessage);     return 0;}
        int setTimestamp(string nTimestamp) { this->timestamp = std::move(nTimestamp); return 0;}
        int setCommitID (string nCommitID)  { this->commitID = std::move(nCommitID);   return 0;}
};
