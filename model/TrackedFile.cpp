...
// NOTE: for now just fully replaces entire file content with new content. If we're doing it different I can change
void TrackedFile::updateContent (const string& content) { this->setContent(content); }
